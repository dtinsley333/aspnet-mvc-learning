...
<asp:Content ID="headContent" ContentPlaceHolderID="HeadContent" runat="server">
 ...
 <script type="text/javascript" language="javascript">
     $(function () {
         $('.button-setreleasereadyflag').click(function () {
             return confirm('Are you sure you want to set the release ready flag on the selected part set ups? ');
         });
     });
</script>
...
<asp:Content ID="indexContent" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <div id="partsetups">
      ...
      <h2>Edit Release Ready Flags</h2>
     
      	<div class='pageheaders'>Global Update Search </div><br /><br />
        <%using (Html.BeginForm("PartSetUpGlobalReleaseReadyEditor", "PartSetUp"))
          { %>
...
Cancel
    ...
    <%using (Html.BeginForm("GlobalReleaseReadyEdits", "PartSetUp"))
      {
...
<td> <%=Html.CheckBoxFor(a => a.IsCurrentlyReleaseReady)%></td><td><span class="button-setreleasereadyflag"><input type="submit"class="button" value="Set Release Ready Flag for Selected Part Set Ups" /> </span></td></tr>
   <a href="javascript:history.go(-1)">
Cancel
</a> 
         </table>
