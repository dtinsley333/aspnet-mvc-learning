...
<br /><br /><br /><br /><br /><br /><br />
    ...
    <div class='pageheaders' style="width:60%;" >Link Quality Alert File to <%=Model.ItemID%> Part Set Up</div><br />


    <% using (Html.BeginForm("GetQualityAlertFile", "PartSetUp"))
		{ %>
...
<table>
 <tr><td>Quality Alert #1 Effective Start Date:<%=Html.TextBoxFor(model => model.PartSetUp.QualityAlertStartDte, new { @id = "startdate" })%>&nbsp;(Date you want the Quality Alert to begin printing with the Travel Card.)</td></tr>
    <tr><td>Quality Alert #1 Effective End Date:<%=Html.TextBoxFor(model => model.PartSetUp.QualityAlertEndDte, new { @id = "enddate" })%>&nbsp;(Date you want the Quality Alert to stop printing with the Travel Card, leaving blank means it will print indefinitely.)</td></tr>
       <tr><td class="style1" bgcolor="#EDEEF7" >Quality Alert :<label for="file">Select File (<img src="<%=pdfImagegfilepath %> "/> PDF only):</label>
